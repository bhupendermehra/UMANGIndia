...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
        ...
        <div class="prose max-w-none text-slate-700 leading-relaxed space-y-4">
            ...
            <p>UmangIndia is an informational website that aggregates and presents details about government schemes and welfare initiatives. This website is provided for informational purposes only and is <strong>NOT an official government website</strong>. We are an independent, privately-run resource and are not affiliated with, endorsed by, or officially connected to any government body, agency, or department. We do not represent, act on behalf of, or claim to speak for any government entity.</p>
